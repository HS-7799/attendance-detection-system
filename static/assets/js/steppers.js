...
formBtn1.addEventListener("click", function(e) {
    gotoNextStep(formBtn1, formBtnNext2, 1, 2)
    e.preventDefault()
})
  
// Next button listener of form 2
formBtnNext2.addEventListener("click", function(e) {
    gotoNextStep(formBtnNext2, formBtn3, 2, 3)
    e.preventDefault()
})

// Previous button listener of form 2
formBtnPrev2.addEventListener("click", function(e) {
    gotoNextStep(formBtnNext2, formBtn1, 2, 1)
    e.preventDefault()
})
...
document.querySelector(".form--message").innerHTML = `
    <h1 class="form--message-text">The student is successfully detected </h1>
    `
e.preventDefault()
})

const gotoNextStep = (prev, next, stepPrev, stepNext) => {
